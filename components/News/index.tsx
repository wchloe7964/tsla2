        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 animate-tesla-reveal">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-500 dark:text-gray-400 font-light max-w-xl">
              Real-time intelligence on market shifts, technological milestones,
            ...
            <Link
              ...
              <div className="relative aspect-video mb-6 overflow-hidden bg-gray-100 dark:bg-white/5">
                ...
                <div className="absolute top-0 right-0 p-4">
                  <div
                    className={`text-[10px] uppercase tracking-[0.2em] font-bold px-2 py-1 bg-white/90 dark:bg-black/90 backdrop-blur-md border border-gray-100 dark:border-white/10 ${getSentimentColor(article.sentiment)}`}>
